-- FUNCTION: public.qdgc_getrecursivestring(double precision, double precision, integer, text)

-- DROP FUNCTION IF EXISTS public.qdgc_getrecursivestring(double precision, double precision, integer, text);

CREATE OR REPLACE FUNCTION public.qdgc_getrecursivestring(
...
ALTER FUNCTION public.qdgc_getrecursivestring(double precision, double precision, integer, text)
    OWNER TO mesa;
