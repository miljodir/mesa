...
The files in this folder covers such tiles for Ghana on what is 
referred to as level 2. A buffer to the closest full degree
around the country is used.

Delivered files:
qdgc_02_gha.dbf   Attribute file
qdgc_02_gha.prj   Projection file
qdgc_02_gha.shp   Spatial data file (shapefile)
qdgc_02_gha.shx   Index file

The files were packed in individual zipped folders together with
this readme file.
...
Ragnvald Larsen
Trondheim 1st of December, 2014
